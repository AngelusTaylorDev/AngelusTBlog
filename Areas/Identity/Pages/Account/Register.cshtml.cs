        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                { 
                    ...
                    // If the image is null use the default image
                    BlogUserImage = (await _imageService.EncodeImageAsync(Input.ImageFile)) ?? 
                                     await _imageService.EncodeImageAsync(_configuration["DefaultUserImage"]),

                    // If the input file type is null get the default imige type
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Welcome to Angelus T Blog. Please confirm your email by cliking the below link.",
